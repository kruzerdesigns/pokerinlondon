...
Route::group(['prefix' => 'casino'], function () {
	...
	Route::get('{casino}',array('as' => 'casino-tournaments', 'uses' => 'CasinoController@getCasinosTournamets'));
	Route::get('{casino}/tweet',array('as' => 'vic-scrape', 'uses' => 'CasinoController@getIndex'));
});
